  ...
  return (
    <>
      ...
      <p className="w-[480px] pl-2 text-[16px] text-gray-500">
        Trở thành Xmember để nhận những ưu đãi đặc biệt chỉ dành riêng cho thành
        viên của Xhotel
      </p>
      <div className="p-3">
      ...
      <div className="p-3 flex justify-between items-center w-[480px] text-[12px] text-gray-400">
        Mật khẩu phải có ít nhất 8 ký tự không dấu gồm chữ cái in hoa, chữ cái
        thường, số và ký tự đặc biệt
      </div>
      <button className="border border-lime-600 bg-lime-500 rounded-2xl w-[480px] ml-3 p-3">
